...
def aptidao_individuo(cromossomo: str, n_genes: int, pontos: Dict[str, Tuple[float, float]]) -> float:
...
def aptidao(pop: List[List[str]], n_genes: int, pontos: Dict[str, Tuple[float, float]]) -> List[float]:
...
def cruzamento(pais: List[List[str]], taxa_cruzamento: float) -> List[str]:
...
def mutacao_individuo(filho: List[str], taxa_mutacao: float, n_genes: int) -> List[str]:
...
def mutacao(filhos: List[List[str]], taxa_mutacao: float, n_genes: int) -> List[List[str]]:
...
def selecao_sobreviventes(
        pop: List[List[str]], apt_pop: List[float], filhos: List[List[str]], apt_filhos: List[float]) -> Tuple[
...
def populacao_inicial(tamanho_pop: int, n_genes: int) -> Tuple[List[List[str]], Dict[int, Tuple[float, float]]]:
    ...
    pop: List[List[str]] = [None] * tamanho_pop
...
def imprimir_populacao(pop: List[List[str]], apt: List[float], geracao: int) -> None:
